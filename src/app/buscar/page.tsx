      ...
      <Container>
        <div className="ui-panel rounded-2xl p-5 sm:p-6">
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[300px_1fr]">
            ...
            <section>
              <p className="ui-pill">{filtered.length} profesionales encontrados</p>
              <div className="ui-list-grid mt-3">
                {filtered.map((p) => (
